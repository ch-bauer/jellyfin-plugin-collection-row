...
- [File Transformation plugin](https://github.com/IAmParadox27/jellyfin-plugin-file-transformation)
  ≥ 2.5.x — install it from the repository `https://www.iamparadox.dev/jellyfin/plugins/manifest.json`
  (Dashboard → Plugins → Repositories), then restart Jellyfin.

## Install from plugin repository (recommended)

1. Dashboard → Plugins → Repositories → add
   `https://raw.githubusercontent.com/GITHUB_USER/jellyfin-plugin-collection-section/main/manifest.json`
